...
public class SignupActivity extends Activity {
	...
	// Creating member variables for Signup Activity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mUsername = (EditText) findViewById(R.id.signupActivityUsernameEditText);
		mEmail = (EditText) findViewById(R.id.signupActivityEmailEditText);
		mPassword = (EditText) findViewById(R.id.signupActivityPasswordEditText);
		mSignupButton = (Button) findViewById(R.id.signupActivitySignupButton);
		mCancelButton = (Button) findViewById(R.id.signupActivityCancelButton);
